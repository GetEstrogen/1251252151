...
library.themes = {
    {
        name = 'Default',
        theme = {
['Accent']                    = fromrgb(0, 150, 255),      -- Bright blue accent
['Background']                = fromrgb(10, 12, 18),       -- Very dark blue-black background
['Border']                    = fromrgb(0, 0, 0),
['Border 1']                  = fromrgb(40, 60, 90),       -- Blue-tinged border
['Border 2']                  = fromrgb(20, 30, 50),       -- Dark blue border
['Border 3']                  = fromrgb(5, 10, 15),        -- Very dark blue-black
['Primary Text']              = fromrgb(220, 230, 255),    -- Soft blue-white text
['Group Background']          = fromrgb(20, 30, 50),       -- Dark blue group bg
['Selected Tab Background']   = fromrgb(30, 50, 70),       -- Brighter blue
['Unselected Tab Background'] = fromrgb(10, 12, 18),
['Selected Tab Text']         = fromrgb(180, 220, 255),    -- Bright blue text for selected
['Unselected Tab Text']       = fromrgb(100, 130, 160),    -- Muted blue
['Section Background']        = fromrgb(15, 18, 25),       -- Slightly blue dark
['Option Text 1']             = fromrgb(200, 230, 255),    -- Bright bluish text
['Option Text 2']             = fromrgb(180, 200, 220),    -- Muted blue
['Option Text 3']             = fromrgb(130, 150, 170),    -- Grayish blue
['Option Border 1']           = fromrgb(40, 60, 90),
['Option Border 2']           = fromrgb(20, 40, 60),
['Option Background']         = fromrgb(20, 30, 45),       -- Blue-tinged option bg
["Risky Text"]                = fromrgb(120, 150, 180),    -- Blue risky text
["Risky Text Enabled"]        = fromrgb(0, 150, 255),      -- Bright blue when enabled
        }
    },
    {
name = 'nhilith',
...
['Background']                = fromrgb(0,0,0);        -- Changed to black
['Border']                    = fromrgb(0,0,0);
['Border 1']                  = fromrgb(45,45,45);
['Border 2']                  = fromrgb(31,31,31);     -- Simplified to grayscale
['Border 3']                  = fromrgb(10,10,10);
['Primary Text']              = fromrgb(255,255,255);  -- Changed to white
['Group Background']          = fromrgb(31,31,31);     -- Simplified to grayscale
['Selected Tab Background']   = fromrgb(31,31,31);     -- Simplified to grayscale
['Unselected Tab Background'] = fromrgb(17,17,17);
['Selected Tab Text']         = fromrgb(255,255,255);  -- Changed to white
['Unselected Tab Text']       = fromrgb(160,160,160);  -- Simplified to grayscale
['Section Background']        = fromrgb(17,17,17);
['Option Text 1']             = fromrgb(255,255,255);  -- Changed to white
['Option Text 2']             = fromrgb(195,195,195);
['Option Text 3']             = fromrgb(145,145,145);
['Option Border 1']           = fromrgb(45,45,45);
['Option Border 2']           = fromrgb(0,0,0);
['Option Background']         = fromrgb(24,24,24);     -- Simplified to grayscale
["Risky Text"]                = fromrgb(255,255,255);  -- Changed to white
["Risky Text Enabled"]        = fromrgb(255,255,255); -- Changed to white
        }
    }
}
...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddText({text = "assimov"})
    creditsSection:AddText({text = "de"})
    creditsSection:AddSeparator({text = 'Helpers'});
    creditsSection:AddText({text = "asl"})
    creditsSection:AddText({text = "yuore mom"})
