...
library.themes = {
    {
        name = 'Default',
        theme = {
['Accent']                    = fromrgb(70, 130, 255),      -- Cool, bright blue (no pink)
['Background']                = fromrgb(8, 10, 15),         -- Near-black dark blue
['Border']                    = fromrgb(0, 0, 0),           -- Pure black
['Border 1']                  = fromrgb(30, 50, 80),        -- Steel blue border
['Border 2']                  = fromrgb(15, 25, 40),        -- Dark slate border
['Border 3']                  = fromrgb(5, 8, 12),           -- Deep blue-black
['Primary Text']              = fromrgb(210, 225, 255),     -- Ice-blue text (no purple tint)
['Group Background']          = fromrgb(15, 25, 40),        -- Navy group bg
['Selected Tab Background']   = fromrgb(25, 45, 70),        -- Darker ocean blue
['Unselected Tab Background'] = fromrgb(8, 10, 15),         -- Matches background
['Selected Tab Text']         = fromrgb(160, 200, 255),     -- Arctic blue (no pink)
['Unselected Tab Text']       = fromrgb(90, 120, 150),      -- Grayish blue (muted)
['Section Background']        = fromrgb(12, 15, 22),        -- Cold, dark steel
['Option Text 1']             = fromrgb(190, 215, 255),     -- Bright, crisp blue
['Option Text 2']             = fromrgb(150, 180, 210),     -- Cool, desaturated blue
['Option Text 3']             = fromrgb(110, 140, 170),     -- Slate gray-blue
['Option Border 1']           = fromrgb(30, 50, 80),        -- Steel border
['Option Border 2']           = fromrgb(15, 30, 50),        -- Darker steel
['Option Background']         = fromrgb(18, 25, 38),        -- Deep navy (no purple)
["Risky Text"]                = fromrgb(100, 140, 180),     -- Cold, muted blue
["Risky Text Enabled"]        = fromrgb(70, 130, 255),      -- Matches accent (no pink)
        }
    },
    {
name = 'nhilith',
